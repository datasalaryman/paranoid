...
export function getSolanaExplorerAccountUrl(address: string, chain: SolanaChain, customRpcUrl?: string): string {
    const explorerUrl = new URL(`/address/${encodeURIComponent(address)}`, 'https://explorer.solana.com');
