...
export type Feature = {
    [Namespace]: {
        provider: ParanoidProvider;
    };
};

export class Wallet implements WalletStandard {
    readonly #listeners: { [E in StandardEventsNames]?: StandardEventsListeners[E][] } = {};
    readonly #version = '1.0.0' as const;
    readonly #name = 'Paranoid' as const;
    readonly #icon = icon;
    #account: WalletAccount | null = null;
    readonly #provider: ParanoidProvider;
    ...
    constructor(provider: ParanoidProvider) {
    ...
    #connected = () => {
        ...
        if (address) {
            ...
            if (!account || account.address !== address || !bytesEqual(account.publicKey, publicKey)) {
                this.#account = new WalletAccount({ address, publicKey });
